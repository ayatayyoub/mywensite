...
<head>
    ...
    <link
        rel="stylesheet"
        href="{{asset('./front/assets/vendors/mdi/css/materialdesignicons.min.css')}}"
    />
                ...
                <div class="row" data-aos="fade-up">
                    <div class="col-xl-8 stretch-card grid-margin">
                        <div class="position-relative">
                            <img
                                src="{{asset('front/assets/images/dashboard/banner.jpg')}}"
                                alt="banner"
                                class="img-fluid"
                            />
                            ...
                            <div class="card-body">
                                ...
                                >
                                    ...
                                    <div class="rotate-img">
                                        <img
                                            src="{{asset('front/assets/images/dashboard/home_1.jpg')}}"
                                            alt="thumb"
                                ...
                                >
                                    ...
                                    <div class="rotate-img">
                                        <img
                                            src="{{asset('front/assets/images/dashboard/home_2.jpg')}}"
                                            alt="thumb"
                                            class="img-fluid img-lg"
                                        />
                                    </div>
                                ...
                                >
                                    ...
                                    <div class="rotate-img">
                                        <img
                                            src="{{asset('front/assets/images/dashboard/home_3.jpg')}}"
                                            alt="thumb"
                                            class="img-fluid img-lg"
                                        />
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-4 grid-margin">
                                        <div class="position-relative">
                                            <div class="rotate-img">
                                                <img
                                                    src="{{asset('front/assets/images/dashboard/home_4.jpg')}}"
                                                    alt="thumb"
                                                    class="img-fluid"
                                                />
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-4 grid-margin">
                                        <div class="position-relative">
                                            <div class="rotate-img">
                                                <img
                                                    src="{{asset('front/assets/images/dashboard/home_5.jpg')}}"
                                                    alt="thumb"
                                                    class="img-fluid"
                                                />
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="position-relative">
                                            <div class="rotate-img">
                                                <img
                                                    src="{{asset('front/assets/images/dashboard/home_6.jpg')}}"
                                                    alt="thumb"
                                                    class="img-fluid"
                                                />
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 grid-margin">
                                                <div class="position-relative">
                                                    <div class="rotate-img">
                                                        <img
                                                            src="{{asset('front/assets/images/dashboard/home_7.jpg')}}"
                                                            alt="thumb"
                                                            class="img-fluid"
                                                        />
                                                    </div>
                                  ...
                                  >
                                            ...
                                            <div class="col-sm-6 grid-margin">
                                                <div class="position-relative">
                                                    <div class="rotate-img">
                                                        <img
                                                            src="{{asset('front/assets/images/dashboard/home_8.jpg')}}"
                                                            alt="thumb"
                                                            class="img-fluid"
                                                        />
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 grid-margin">
                                                <div class="position-relative">
                                                    <div class="rotate-img">
                                                        <img
                                                            src="{{asset('front/assets/images/dashboard/home_9.jpg')}}"
                                                            alt="thumb"
                                                            class="img-fluid"
                                                        />
                                                    </div>
                                  ...
                                  >
                                            ...
                                            <div class="col-sm-6 grid-margin">
                                                <div class="position-relative">
                                                    <div class="rotate-img">
                                                        <img
                                                            src="{{asset('front/assets/images/dashboard/home_10.jpg')}}"
                                                            alt="thumb"
                                                            class="img-fluid"
                                                        />
                                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        >
                                            <div class="div-w-80 mr-3">
                                                <div class="rotate-img">
                                                    <img
                                                        src="{{asset('front/assets/images/dashboard/home_11.jpg')}}"
                                                        alt="thumb"
                                                        class="img-fluid"
                                                    />
                                                </div>
                                        ...
                                        >
                                            <div class="div-w-80 mr-3">
                                                <div class="rotate-img">
                                                    <img
                                                        src="{{asset('front/assets/images/dashboard/home_12.jpg')}}"
                                                        alt="thumb"
                                                        class="img-fluid"
                                                    />
                                                </div>
                                        ...
                                        >
                                            <div class="div-w-80 mr-3">
                                                <div class="rotate-img">
                                                    <img
                                                        src="{{asset('front/assets/images/dashboard/home_13.jpg')}}"
                                                        alt="thumb"
                                                        class="img-fluid"
                                                    />
                                                </div>
                                        ...
                                        >
                                            <div class="div-w-80 mr-3">
                                                <div class="rotate-img">
                                                    <img
                                                        src="{{asset('front/assets/images/dashboard/home_14.jpg')}}"
                                                        alt="thumb"
                                                        class="img-fluid"
                                                    />
                                                </div>
                                        ...
                                        >
                                            <div class="div-w-80 mr-3">
                                                <div class="rotate-img">
                                                    <img
                                                        src="{{asset('front/assets/images/dashboard/home_15.jpg')}}"
                                                        alt="thumb"
                                                        class="img-fluid"
                                                    />
                                                </div>
                                    ...
                                    <div class="col-xl-6">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6 col-lg-8 col-sm-6">
                                                <div class="rotate-img">
                                                    <img
                                                        src="{{asset('front/assets/images/dashboard/home_16.jpg')}}"
                                                        alt="thumb"
                                                        class="img-fluid"
                                                    />
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <div class="border-bottom pb-3">
                                                    <div class="rotate-img">
                                                        <img
                                                            src="{{asset('front/assets/images/dashboard/home_17.jpg')}}"
                                                            alt="thumb"
                                                            class="img-fluid"
                                                        />
                                                    </div>
                                                ...
                                                <div class="pt-3 pb-3">
                                                    <div class="rotate-img">
                                                        <img
                                                            src="{{asset('front/assets/images/dashboard/home_18.jpg')}}"
                                                            alt="thumb"
                                                            class="img-fluid"
                                                        />
                                                    </div>
                                                        ...
                                                        <div class="border-bottom pb-3">
                                                            <div class="row">
                                                                <div class="col-sm-5 pr-2">
                                                                    <div class="rotate-img">
                                                                        <img
                                                                            src="{{asset('front/assets/images/dashboard/home_19.jpg')}}"
                                                                            alt="thumb"
                                                        ...
                                                        <div class="border-bottom pb-3 pt-3">
                                                            <div class="row">
                                                                <div class="col-sm-5 pr-2">
                                                                    <div class="rotate-img">
                                                                        <img
                                                                            src="{{asset('front/assets/images/dashboard/home_20.jpg')}}"
                                                                            alt="thumb"
                                                                            class="img-fluid w-100"
                                                                        />
                                                                    </div>
                                                        ...
                                                        <div class="border-bottom pb-3 pt-3">
                                                            <div class="row">
                                                                <div class="col-sm-5 pr-2">
                                                                    <div class="rotate-img">
                                                                        <img
                                                                            src="{{asset('front/assets/images/dashboard/home_21.jpg')}}"
                                                                            alt="thumb"
                                                                            class="img-fluid w-100"
                                                                        />
                                                                    </div>
                                                        ...
                                                        <div class="pt-3">
                                                            <div class="row">
                                                                <div class="col-sm-5 pr-2">
                                                                    <div class="rotate-img">
                                                                        <img
                                                                            src="{{asset('front/assets/images/dashboard/home_22.jpg')}}"
                                                                            alt="thumb"
                                                                            class="img-fluid w-100"
                                                                        />
                                                                    </div>
        ...
        <footer>
            <div class="footer-top">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-5">
                            <img src="{{asset('front/assets/images/logo.svg')}}" class="footer-logo" alt="" />
